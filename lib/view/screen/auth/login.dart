    ...
    return Scaffold(
      ...
      body:Container(
        ...
        children: [
          ...
          Container(margin:const EdgeInsets.symmetric(horizontal: 45),child: const Text("Sign In For Stay Fit",style: TextStyle(fontSize: 30,color: Colors.white))),
          const SizedBox(height: 80,),
          const Customtextformauth(hinttext: "abc1123@gmail.com", LabelText: "Email", icondata: Icons.email,  isNumber: false,),
          const Customtextformauth(hinttext: "********", LabelText: "Password", icondata: Icons.lock,  isNumber: false,obscureText: true,),
